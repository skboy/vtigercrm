...
class Users_CRMSetup {
	...
	public static function getPackagesList() {
		...
		$packagesList = array(
			'Tools' => array(
				'label' => vtranslate('Contact Management','Install'),
				'imageName' => 'BasicPackage.png',
				'description' => vtranslate('Contact Management Description','Install'),
				'modules' => array(
					'Contacts' => 'Contacts',
			...
			'Sales' => array(
				'label' => vtranslate('Sales Automation','Install'),
				'imageName' => 'SalesAutomation.png',
				'description' => vtranslate('Sales Automation Description','Install'),
				'modules' => array(
					'Potentials' => 'Opportunities'
				)),
			'Marketing' => array(
				'label' => vtranslate('Marketing','Install'),
				'imageName' => 'Marketing.png',
				'description' => vtranslate('Marketing Description','Install'),
				'modules' => array()),

			'Support' => array(
				'label' => vtranslate('Support','Install'),
				'imageName' => 'Support.png',
				'description' => vtranslate('Support Description','Install'),
				'modules' => array(
					'HelpDesk' => 'Tickets',
			...
			'Inventory' => array(
				'label' => vtranslate('Invoicing & Inventory Management','Install'),
				'imageName' => 'Inventory.png',
				'description' => vtranslate('Invoicing & Inventory Management Description','Install'),
				'modules' => array(
					'Quotes' => 'Quotes',
					'Invoice' => 'Invoice',
			...
			'Project' => array(
				'label' => vtranslate('Project Management','Install'),
				'imageName' => 'ProjectManagement.png',
				'description' => vtranslate('Project Management Description','Install'),
				'modules' => array(
					'Project' => 'Projects',
					'ProjectTask' => 'Tasks',
