									...
									<td class="{$WIDTHTYPE} fieldValue">
										<div class=" col-lg-6 col-md-6 col-sm-12">
											<select class="select2 inputElement col-lg-12 col-md-12 col-lg-12" name="serverType">
												...
												<option value="{"ssl://smtp.qq.com:465"}" {if {$MODEL->get('server')} eq "ssl://smtp.qq.com:465"} selected {/if}>{vtranslate('LBL_QQMAIL', $QUALIFIED_MODULE)} </option>
												<option value="{"ssl://smtp.exmail.qq.com:465"}" {if {$MODEL->get('server')} eq "ssl://smtp.exmail.qq.com:465"} selected {/if}>{vtranslate('LBL_QQEXMAIL', $QUALIFIED_MODULE)} </option>
												<option value="{"ssl://smtp.163.com:465"}" {if {$MODEL->get('server')} eq "ssl://smtp.163.com:465"} selected {/if}>{vtranslate('LBL_163MAIL', $QUALIFIED_MODULE)} </option>
